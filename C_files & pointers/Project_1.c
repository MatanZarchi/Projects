...
node* Insert(node* head, ArrayData data)//הכנסת איבר לרשימה
{
...
intnode* Insert1(intnode* head, int data)//הכנסת איבר לרשימה
{
...
charnode* Insert2(charnode* head, char data)//הכנסת איבר לרשימה
{
